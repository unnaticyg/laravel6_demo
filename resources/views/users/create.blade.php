                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gender_0" type="radio" value="Male" checked="checked" name="gender" value="{{ old('gender') }}">Male
                                <input id="gender_1" type="radio" value="Female" name="gender" value="{{ old('gender') }}">Female
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{route('users')}}"><button type="button" class="btn btn-secondary">
                                    {{ __('Back') }}
                                </button></a>
                            </div>
                        </div>
